...
Starting point for any RequireJS app is a `dependencies.js`, which should be used to define the components and their
...
You can avoid passing of `controllerUrl` if you define it in your `dependencies.js` as:
